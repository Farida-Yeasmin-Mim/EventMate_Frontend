    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', display: 'block', my: 2 } }}>
              <Link to="/" style={{ textDecoration: 'none', color: 'white' }} ><MenuItem> Home</MenuItem></Link>
              <Link to="/login" style={{ textDecoration: 'none' }}><MenuItem>Login</MenuItem></Link>
              <Link to="/signup" style={{ textDecoration: 'none' }}><MenuItem>Signup</MenuItem></Link>
          </Box>
