...
const ListItem = ({
  ...
  return (
    <div className="listItem-wrap">
      ...
      <footer>
        <div>
          <p className="vendorName">{item.vendor}</p>
          <p><b>Tk{item.price}</b></p>
...

        {
          cart.some(p => p.id === item.id) ? (
            <>
              <Link style={{ textDecoration: 'none', color: 'rgb(36, 87, 255)' }} to={"/decoration_details/" + item.id}><b>VIEW</b></Link>
