      ...
      <Dialog open={open} onClose={handleClose}>
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField id='outlined-basic' label='Location' variant='outlined' type='contact' fullWidth /><br/><br/>
                <SelectAreas/>
                <TextField id='outlined-basic' label='Max Guest No.' variant='outlined' fullWidth/><br/><br/>
                <TextField id='outlined-basic' label='Budget' variant='outlined' fullWidth /><br/><br/>
